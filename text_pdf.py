...
def convert():
 ...
 #generating a complete pdf file with name fileto.pdf
 pdf.output("fileto.pdf")
 #showing success message
 msgForGenerate.set("fileto.pdf is generated successfully")
#uploading Textfile
def UploadAction():
    #uploading file
...
root.title("Text File to PDF Converter")
...
Label(root,text="Hello",textvariable=msgForUpload,font="Arial 12",bg="#b115c2",fg="white").place(x=80,y=30)
...
Label(root,text="Hello",textvariable=msgForGenerate,font="Arial 12",bg="#b115c2",fg="white").place(x=80,y=120)
root.mainloop()